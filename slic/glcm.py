...
def glcm_features(image_name):
    ...
    return [mean,  con,  Auto_correlation, std]
#角二阶矩（Angular Second Moment, ASM) 熵（Entropy, ENT) 对比度Con 反差分矩阵（Inverse Differential Moment, IDM)
#2,4,5显示不明显


# if __name__ == '__main__':
#     result1_3 = glcm_features("./testpic/90.png")
#     print(result1_3)
#     result1_4 = glcm_features("./testpic/125.png")
#     print(result1_4)
#     result1_5 = glcm_features("./testpic/255.png")
#     print(result1_5)
#     result1_6 = glcm_features("./testpic/333.png")
#     print(result1_6)
#     result1_7 = glcm_features("./testpic/444.png")
#     print(result1_7)
#     result1_8 = glcm_features("./testpic/555.png")
#     print(result1_8)
