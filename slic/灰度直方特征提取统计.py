...
# #测试
# print('测试')
# print(gray_features('testpic/78.png'))
# print(gray_features('testpic/89.png'))
# print(gray_features('testpic/1.png'))
# print(gray_features('testpic/8.png'))
# print(gray_features('testpic/38.png'))

# # 顺序遍历testpic文件夹下的图片的路径
...
#
# #测试执行
# #print(gray_features('testpic'))
# img = cv2.imread("testpic/89.png",0)
# hist = cv2.calcHist([img],[0],None,[256],[0,255])   #读取灰度矩阵，cv2.calcHist为简单的灰度直方图比较方法
# hist = hist[1:256] #去除0(背景黑色)
# print(hist)
# plt.plot(hist,color='y')
